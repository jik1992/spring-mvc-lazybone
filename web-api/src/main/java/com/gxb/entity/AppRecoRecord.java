 ...
 *
 */
@TableName(value = "app_reco_record")
public class AppRecoRecord implements Serializable {
	...
	public Integer getRecouser() {
		return this.recouser;
	}

	public void setRecouser(Integer recouser) {
		this.recouser = recouser;
	}

	public String getRecomobile() {
		return this.recomobile;
	}
